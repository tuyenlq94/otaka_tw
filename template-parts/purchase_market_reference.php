...
<section id="" class=" shop__detail--rate rateSection">
    <div class="shop__detail--rateTable" id="ratebox" v-cloak="">
        <h3 class="titleSub">
            Gold and Platinum Reference Purchase Prices
        </h3>
        <p>
            These are the prices for gold, platinum, and silver based on different types.<br>
            The prices listed below may vary depending on the shape, so please contact us by phone for more details.
        </p>
        <br>
        ...
        <h4 class="titleH4">
            Today's reference purchase price for gold per gram.
        </h4>
        <table>
            <tbody>
                <tr>
            ...
            <tbody>
                <tr>
                    <th class="rateTable--gold" colspan="2">
                        Today's Reference Purchase Price for Gold and Platinum Combination per Gram
                    </th>
                </tr>
                <tr>
            ...
            <tbody>
                <tr>
                    <th class="rateTable--pt" colspan="2">
                        Today's Reference Purchase Price for Platinum per Gram
                    </th>
                </tr>
                <tr>
            ...
            <tbody>
                <tr>
                    <th class="rateTable--pd" colspan="3">
                        Today's Reference Purchase Price for Palladium per Gram
                    </th>
                </tr>
                <tr>
            ...
            <tbody>
                <tr>
                    <th class="rateTable--sv" colspan="3">
                        Today's Reference Purchase Price for Silver per Gram
                    </th>
                </tr>
                <tr>
