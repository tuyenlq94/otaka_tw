...
<body id="mock_app">
	...
	<div class="fv_img_wrap">
		<img class="is-pc" src="images/index/OTAKARAYA_top_PC.webp" alt="不想虧錢嗎？那麼，購買高價商品時，一定不要錯過「Otakaraya」！">
		<img class="is-sp" src="images/index/OTAKARAYA_top_SP.webp" alt="不想虧錢嗎？那麼，購買高價商品時，一定不要錯過「Otakaraya」！">
	</div>
					...
					<div class="content_area">
						<div class="reason_section_content_wrap">
							<div class="reason_area_img_wrap" style="position: relative;">
								<span class="reason_numbering" style="position: absolute; left: 0px;">01</span>
							...
							<div class="reason_area_img_wrap" style="position: relative;">
								<span class="reason_numbering" style="position: absolute; left: 0px;">02</span>
							...
							<div class="reason_area_img_wrap" style="position: relative;">
								<span class="reason_numbering" style="position: absolute; left: 0px;">05</span>
								<img src="images/index/reason_img_5.webp">
								<div class="reason_section_text_area">
									<p class="reason_section_ttl">收購範圍廣泛</p>
									<p class="reason_section_text">不論是什麼物品，只要您認為有價值，我們都能為您提供高價收購！</p>
								</div>
							</div>
							<div class="reason_area_img_wrap" style="position: relative;">
							...
							<div class="reason_area_img_wrap" style="position: relative;">
								<span class="reason_numbering" style="position: absolute; left: 0px;">08</span>
								<img src="images/index/High-Price_Purchase_Campaign_PC.webp">
								<div class="reason_section_text_area">
									<p class="reason_section_ttl">高價收購優惠活動</p>
									<p class="reason_section_text">我們定期舉行高價收購活動，讓顧客享受更多優惠！</p>
								</div>
							</div>
							<div class="reason_area_img_wrap" style="position: relative;">
								<span class="reason_numbering" style="position: absolute; left: 0px;">09</span>
								<img src="images/index/reason_img_9.webp">
								<div class="reason_section_text_area">
									<p class="reason_section_ttl">內部拍賣平台，降低成本</p>
									<p class="reason_section_text">我們利用自家拍賣平台，降低營運成本，從而以更高收購價格回饋給顧客！</p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="csr_section_content">
					...
					<div class="dining_room_area">
						...
						<div class="dining_room_area_read">
							<p>E-fran兒童餐廳在日本每週提供兩次(每週150份)、在菲律賓每週一次(100份)營養餐點或便當的援助活動。<br>另外,在日本國內我們參與地區活動貢獻社會,在菲律賓則舉辦聖誕節等活動,發送禮物給孩子們。
							</p>
						</div>
						...
						<div class="dining_room_img_area">
							...
							<div class="dining_room_img_area_wrap dining_room_img_area_wrap3">
								...
								<p class="dining_room_img_area_text">
									2021年的颱風和2023年的大規模火災在菲律賓造成巨大損失。.在許多人陷入困境時,我們進行了發放現有食物給受災者的活動。
									.目前面臨的問題是無法讓所有人都獲得這些物資。.E-fran會全力提供支援,讓更多人能收到物資。</p>
							</div>
